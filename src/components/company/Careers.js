        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row items-center">
            ...
            <div className="md:w-1/2 mt-6 md:mt-0">
              <img src={careersImage} alt="Careers" className="w-full" />
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="py-12 bg-white">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-y-12 gap-x-6">
            <div>
              <img src={got01} alt="Unlimited PTO" className="mb-3 w-16" />
            ...
            <div>
              <img src={got07} alt="Growth" className="mb-3 w-16" />
            ...
            <div>
              <img src={got03} alt="Health Insurance" className="mb-3 w-16" />
            ...
            <div>
              <img src={got4} alt="Well-being" className="mb-3 w-16" />
            ...
            <div>
              <img src={got5} alt="Mindfulness" className="mb-3 w-16" />
            ...
            <div>
              <img src={got06} alt="Supportive Environment" className="mb-3 w-16" />
